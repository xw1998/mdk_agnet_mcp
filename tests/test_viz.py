...
def section_e():
    ...
    check("E4 注册进服务（总数 200）", "view_render" in names and len(names) == 200, len(names))
...
def section_f():
    ...
    check("F3 文档工具数同步为 200 / 收起 156",
          "200 个" in readme and "156 个" in readme and
          "200 个工具" in skill and "156 个" in skill, "")
