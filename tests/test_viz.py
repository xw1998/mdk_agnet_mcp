...
def section_e():
    ...
    check("E4 注册进服务（总数 195）", "view_render" in names and len(names) == 195, len(names))
...
def section_f():
    ...
    check("F3 文档工具数同步为 195 / 收起 151",
          "195 个" in readme and "151 个" in readme and
          "195 个工具" in skill and "151 个" in skill, "")
