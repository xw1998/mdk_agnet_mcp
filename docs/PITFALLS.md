...
- [二十三、分析层的四条「看着正常、实际是错的数」（批次72）](#二十三分析层的四条看着正常实际是错的数批次72)
- [二十九、把外设「绕过固件」直接驱动：区分固件缺陷与核心/硬件楔死](#二十九把外设绕过固件直接驱动区分固件缺陷与核心硬件楔死)
...
## 二十九、把外设「绕过固件」直接驱动：区分固件缺陷与核心/硬件楔死
